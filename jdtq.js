...
设置CK = 12👉 点击福利 - 视频 - 获取视频body
设置CK = 13 👉 点击福利 - 视频完成 - 获取视频完成body，
设置CK = 14 👉 点击福利 - 视频完成- 翻倍 - 获取视频完成翻倍body，

设置CK = 15 👉 点击福利 - 获取签到body， 
设置CK = 16 👉 点击福利 - 签到翻倍 - 获取签到翻倍body，
设置CK = 17👉 点击福利 - 签到完成 - 获取签到完成body，
设置CK = 18👉 点击福利 - 签到完成翻倍 -获取签到完成翻倍body，

设置CK = 19 👉 点击福利 - 查看实时天气 - 获取天气body， 
设置CK = 20👉 点击福利 - 查看实时天气完成 - 获取天气完成body，
设置CK = 21👉 点击福利 - 查看实时天气完成翻倍 - 获取天气完成翻倍body，

设置CK = 22👉 点击福利 - 悬浮完成 - 获取悬浮完成body，
设置CK = 23👉 点击福利 - 悬浮完成翻倍 - 获取悬浮完成翻倍body

第二步⚠️添加 hostname = api.jiandantianqi.com,添加api body重写 获取api body

设置CK = 24 👉 点击活动-每天抽奖-获取抽奖页body，
设置CK = 25 👉 点击活动 - 每天抽奖 - 抽奖， 获取抽奖body，
设置CK = 26 👉  点击活动 - 每天抽奖 - 看视频获取抽奖次数，获取抽奖次数body
...
设置CK = 31 👉点击活动 - 吃饭领福利 - 吃饭2翻倍 - 获取吃饭2翻倍body，
设置CK = 32 👉 点击活动 - 吃饭领福利 - 吃饭3， 获取吃饭3body，
设置CK = 33👉 点击活动 - 吃饭领福利 - 吃饭3翻倍 - 获取吃饭3翻倍body，
设置CK = 34 👉 点击活动 - 吃饭领福利 - 吃饭4， 获取吃饭4body，
设置CK = 35👉 点击活动 - 吃饭领福利 - 吃饭4翻倍 - 获取吃饭4翻倍body，
设置CK = 36👉 点击活动 - 吃饭领福利 - 吃饭5， 获取吃饭5body，
设置CK = 37👉 点击活动 - 吃饭领福利 - 吃饭5翻倍 - 获取吃饭5翻倍body，
...
//简单天气获取zt body  日常任务
https:\/\/zt\.jiandantianqi\.com\/ url script-request-body https://cdn.jsdelivr.net/gh/ziye888/JavaScript@main/Task/jdtq.js, tag=简单天气获取日常任务body
...
hostname = event.jiandantianqi.com
//简单天气获取event body  吃饭 竞猜
https:\/\/event\.jiandantianqi\.com\/ url script-request-body https://cdn.jsdelivr.net/gh/ziye888/JavaScript@main/Task/jdtq.js, tag=简单天气获取吃饭-竞猜body

//////////////////////////// loon
hostname = zt.jiandantianqi.com,
//简单天气获取zt body  日常任务
http-request https:\/\/zt\.jiandantianqi\.com\/ script-path=https://cdn.jsdelivr.net/gh/ziye888/JavaScript@main/Task/jdtq.js, requires-body=1,max-size=0, tag=简单天气获取日常任务body

hostname = api.jiandantianqi.com,
//简单天气获取api body  抽奖
http-request https:\/\/api\.jiandantianqi\.com\/ script-path=https://cdn.jsdelivr.net/gh/ziye888/JavaScript@main/Task/jdtq.js, requires-body=1,max-size=0, tag=简单天气获取抽奖body

hostname = event.jiandantianqi.com
//简单天气获取event body  吃饭 竞猜
http-request https:\/\/event\.jiandantianqi\.com\/ script-path=https://cdn.jsdelivr.net/gh/ziye888/JavaScript@main/Task/jdtq.js, requires-body=1,max-size=0, tag=简单天气获取吃饭-竞猜body

//////////////////////////// surge
hostname = zt.jiandantianqi.com,
//简单天气获取zt body  日常任务
简单天气获取日常任务body = type=http-request,pattern=https:\/\/zt\.jiandantianqi\.com\/,requires-body=1,max-size=0,script-path=https://cdn.jsdelivr.net/gh/ziye888/JavaScript@main/Task/jdtq.js

hostname = api.jiandantianqi.com,
//简单天气获取api body  抽奖
简单天气获取抽奖body = type=http-request,pattern=https:\/\/api\.jiandantianqi\.com\/,requires-body=1,max-size=0,script-path=https://cdn.jsdelivr.net/gh/ziye888/JavaScript@main/Task/jdtq.js

hostname = event.jiandantianqi.com
//简单天气获取event body  吃饭 竞猜
简单天气获取吃饭-竞猜body = type=http-request,pattern=https:\/\/event\.jiandantianqi\.com\/,requires-body=1,max-size=0,script-path=https://cdn.jsdelivr.net/gh/ziye888/JavaScript@main/Task/jdtq.js
